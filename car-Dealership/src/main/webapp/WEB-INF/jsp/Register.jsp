...
<main class="form-signin">
		<form:form class="row g-3" method="post" action="/vehicle" modelAttribute="vehicle" enctype="multipart/form-data">
		<div class="col-md-6">
